        ...
        >
            <CardHeader className="flex flex-row items-center gap-4 pb-2 select-none">
                <Avatar className="h-12 w-12 border-2 border-white dark:border-zinc-700 shadow-sm">
                    ...
                    <AvatarFallback className="bg-indigo-100 dark:bg-indigo-500/20 text-indigo-700 dark:text-indigo-400 font-bold">{review.avatar}</AvatarFallback>
                </Avatar>
                <div className="flex-1">
                    <div className="font-semibold text-slate-900 dark:text-zinc-100">{review.name}</div>
                    <div className="text-xs text-slate-500 dark:text-zinc-500">{review.role}</div>
                </div>
                <ChevronDown className={cn("w-5 h-5 text-slate-300 dark:text-zinc-500 transition-transform duration-300 group-hover:text-indigo-500 dark:group-hover:text-indigo-400", isOpen && "rotate-180")} />
            </CardHeader>
