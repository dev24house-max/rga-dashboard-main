                ...
                {PRODUCTS.map((product) => (
                    ...
                    >
                        ...
                        <div className="flex flex-col flex-1 p-5 text-slate-900 dark:text-zinc-100 bg-white dark:bg-zinc-800">
                            <h2 className="text-lg sm:text-xl font-bold mb-1.5 tracking-tight group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">{product.name}</h2>
                            <p className="text-[11px] sm:text-xs text-slate-500 dark:text-zinc-500 line-clamp-2 sm:line-clamp-3 mb-3 leading-relaxed">
                                {product.description}
                            </p>
                            <div className="mt-auto">
                                <Button size="sm" className="w-full bg-slate-900 dark:bg-zinc-700 text-white hover:bg-indigo-600 dark:hover:bg-indigo-600 transition-colors shadow-none text-xs h-8 sm:h-9 rounded-lg font-semibold">
                                    Buy Now
                                </Button>
                            </div>
                        </div>
