                ...
                setAnchorData([
                    {
                        ...
                        referringDomains: 45,
                        totalBacklinks: 234,
                        dofollowBacklinks: 189,
                        traffic: 1250,
                        trafficPercentage: 12.5,
                    },
                    {
                        text: 'learn more',
                        referringDomains: 38,
                        totalBacklinks: 198,
                        dofollowBacklinks: 167,
                        traffic: 980,
                    ...
                    },
                    {
                        ...
                        referringDomains: 32,
                        totalBacklinks: 156,
                        dofollowBacklinks: 134,
                        traffic: 850,
                        trafficPercentage: 8.5,
                    },
                    {
                        text: 'view details',
                        referringDomains: 28,
                        totalBacklinks: 142,
                        dofollowBacklinks: 121,
                        traffic: 720,
                        trafficPercentage: 7.2,
                    },
                    {
                        text: 'shop now',
                        referringDomains: 25,
                        totalBacklinks: 128,
                        dofollowBacklinks: 109,
                        traffic: 650,
                        trafficPercentage: 6.5,
                    },
                ]);
            } finally {
                setLoading(false);
            ...
            <Card className="h-[310px] flex flex-col shadow-sm">
                <CardHeader className="p-3 pb-2 border-b flex flex-row items-center justify-between shrink-0">
                    ...
                    <div className="text-[10px] text-muted-foreground font-medium uppercase">
                        {t('anchorText.referringDomains')}
                    </div>
                </CardHeader>
                <CardContent className="p-0 flex-1 min-h-0 overflow-auto">
                    <div className="flex items-center justify-center h-full">
                        <div className="text-xs text-muted-foreground">
                            {t('anchorText.loading')}
                        </div>
                    </div>
                </CardContent>
            </Card>
