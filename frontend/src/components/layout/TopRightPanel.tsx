    ...
    <div className="fixed top-4 right-6 z-50 flex items-center gap-3">
      {pagePath && (
        <div className="group relative">
          ...
          {/* Tooltip */}
          <div className="pointer-events-none absolute right-0 top-12 whitespace-nowrap rounded-md bg-slate-900 px-2 py-1 text-xs text-white opacity-0 shadow-lg transition-opacity duration-200 group-hover:opacity-100">
            Tutorial
          </div>
        </div>
      )}
